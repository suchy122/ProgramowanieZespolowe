...
import Controller.Admin.CustomersOrder2;
...

                    {
                        btn.setOnAction((ActionEvent event) -> {
                            try {
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/User/Orders2.fxml"));
                                AnchorPane ap = loader.load();
                                Orders2 orders2 = loader.getController();
