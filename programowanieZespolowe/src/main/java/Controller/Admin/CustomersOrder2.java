...
/**
 * The type Customers order 2.
 */
public class CustomersOrder2 implements Initializable {
    @FXML
    ...
    @FXML
    private Label orderDetailLabelStatus;
    ...
    /**
     * Method for displaying data in next window.
     *
    ...
    public void metoda(int idOrder) {
        try {
            ...
            if (status.equals("Anulowane") || status.equals("Zakończone")){
                ...
                orderDetailStatus.setVisible(false);
                orderDetailLabelStatus.setVisible(false);
            }
