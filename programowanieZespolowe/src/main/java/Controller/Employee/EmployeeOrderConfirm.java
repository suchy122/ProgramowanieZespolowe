...
/**
 * The type Employee order confirm.
 */
public class EmployeeOrderConfirm implements Initializable {
     ...
     * The Id.
     */
    int id = EmployeeMainController.idUser;
    ...
    public void orderConfirm() {
        try {
            ...
            st2.setInt(1, EmployeeMainController.idUser);
            ...
            st3.setInt(1, EmployeeMainController.idUser);
            ...
            while (rs2.next()) {
                ...
                cena = rs2.getDouble("Price");
                cena = cena - cena * 0.1;
                st4.setDouble(3, cena);
            ...
            st5.setInt(1, EmployeeMainController.idUser);
            st5.executeUpdate();
